...
```
git clone git@github.com:rsimai/cockpit-geeko.git
cd cockpit-geeko
make
```
...
ln -s `pwd`/dist ~/.local/share/cockpit/cockpit-geeko
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/cockpit-geeko

# Running eslint

Cockpit Geeko uses [ESLint](https://eslint.org/) to automatically check
...
your project after forking from cockpit-geeko.
...
After cloning the Cockpit Geeko you should rename the files, package names, and
 ...
 * The [Cockpit Geeko announcement](https://cockpit-project.org/blog/cockpit-geeko.html)
